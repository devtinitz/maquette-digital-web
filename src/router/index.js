...
const routes = [
  ...
  },
  {
    ...
    meta: { requiresAuth: true },
    children: [
      { path: 'dashboard', name: 'admin-event-dashboard', component: DummyEventView },
      { path: 'devices', name: 'admin-event-devices', component: DummyEventView },
      ...
      { path: 'campaigns', name: 'admin-event-campaigns', component: DummyEventView },
      { path: 'votes', name: 'admin-event-votes', component: DummyEventView },
      { path: 'forms', name: 'admin-event-forms', component: DummyEventView },
      { path: 'ticketing', name: 'admin-event-ticketing', component: DummyEventView },
